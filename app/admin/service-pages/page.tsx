  ...
  return (
    <div className="space-y-8 text-black">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.35em] text-slate-400">Service Pages</p>
          <h1 className="text-3xl font-semibold text-slate-900">Add Service Pages</h1>
          <p className="mt-2 text-sm text-slate-600">
            Create and manage service pages with multiple sections, table of contents, and rich content
          </p>
        </div>
