...
function renderBlock(
  ...
  switch (block.type) {
    ...
    case "header":
      ...
      const headerProps = {
        className: `font-semibold ${headingColor} ${headerSizes[level as keyof typeof headerSizes] || headerSizes[2]} tracking-tight`,
        dangerouslySetInnerHTML: { __html: block.data.text || "" },
      };
      switch (level) {
        case 1:
    ...
    case "table":
      return (
        <div key={block.id} className="mb-8 overflow-hidden rounded-lg border border-slate-200 dark:border-slate-800">
    ...
    case "column":
      ...
      const flexDirection =
        columnData.imagePosition === "right" ? "md:flex-row-reverse" : "md:flex-row";
