...
export default function MediaMentions() {
  ...
  const displayedItems = showAll 
    ? rows 
    : rows.slice(currentBatch * itemsPerBatch, (currentBatch + 1) * itemsPerBatch);
      ...
      <div className="max-w-6xl mx-auto lg:px-0 px-5">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
            How to lay the foundation of your dream business: choosing between private limited, LLP, and OPC
          </p>
        </div>

        {/* Logo Grid */}
        <div className="relative">
          <div className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 transition-all duration-500`}>
              ...
              >
                ...
                >
                  ...
                  <div className="mt-auto text-center">
                    <h3 className="text-sm font-semibold text-slate-700 mb-1">{item.media}</h3>
                    <p className="text-xs text-gray-500 mb-2">{item.media_type}</p>
        ...
        <div className="flex justify-center mt-12 md:mt-16">
          ...
          >
            {showAll ? (
              ...
              <>
                <span className="text-base md:text-lg">View All Media Mentions</span>
