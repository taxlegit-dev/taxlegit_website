...
export default function ServiceSection() {
  ...
  const contentData: Record<string, ServiceItem[]> = {
    "Company Registration": [
      {
        ...
        desc: "Establish your business as a legally recognized private limited company with limited liability protection, separate legal entity status, and enhanced credibility. Our experts handle complete documentation, DSC & DIN registration, and ensure compliance with MCA regulations for seamless incorporation.",
      ...
      },
      {
        ...
        desc: "Combine the flexibility of partnership with the benefits of limited liability protection. Ideal for professional services firms seeking operational flexibility while maintaining limited liability for partners. We manage LLP agreement drafting, DPIN registration, and incorporation filing.",
        href: "/limited-liability-partnership-registration",
      },
      {
        icon: <User className="w-12 h-12 md:w-16 md:h-16" />,
        title: "One Person Company Registration",
        desc: "Perfect for solo entrepreneurs wanting corporate benefits with single ownership. OPC provides limited liability protection, separate legal identity, and easier access to funding while maintaining complete control. Includes nominee director appointment and compliance setup.",
        href: "/one-person-company-registration",
      },
      {
        icon: <Building className="w-12 h-12 md:w-16 md:h-16" />,
        title: "Public Limited Company Registration",
        desc: "For businesses planning to raise capital from public markets. We facilitate complete registration including SEBI compliance, prospectus filing, and stock exchange listing requirements. Perfect for growth-stage companies seeking equity financing.",
        href: "/public-limited-company-registration",
      },
      {
        icon: <HeartHandshake className="w-12 h-12 md:w-16 md:h-16" />,
        title: "Section 8 Company Registration",
        desc: "For non-profit organizations, charitable trusts, and NGOs seeking tax exemptions and government benefits. We handle license application, MOA & AOA drafting, and ensure compliance with NITI Aayog and CSR regulations for sustainable social impact.",
    ...
    "Government Registration": [
      {
        icon: <Factory className="w-12 h-12 md:w-16 md:h-16" />,
      ...
      {
        icon: <Store className="w-12 h-12 md:w-16 md:h-16" />,
      ...
      {
        icon: <Apple className="w-12 h-12 md:w-16 md:h-16" />,
    ...
    "Tax Filing": [
      {
        icon: <FileBarChart className="w-12 h-12 md:w-16 md:h-16" />,
        title: "Income Tax Return Filing",
        desc: "Comprehensive ITR filing services for individuals, HUF, companies, and partnerships. Includes tax planning, deduction optimization, capital gains computation, and representation before tax authorities. We ensure maximum refunds and compliance with latest tax laws.",
        href: "/income-tax-return-filing",
      },
      {
        icon: <BarChart3 className="w-12 h-12 md:w-16 md:h-16" />,
      ...
      {
        icon: <Calculator className="w-12 h-12 md:w-16 md:h-16" />,
    ...
    Compliance: [
      {
        icon: <ClipboardCheck className="w-12 h-12 md:w-16 md:h-16" />,
      ...
      {
        icon: <BookCheck className="w-12 h-12 md:w-16 md:h-16" />,
      ...
      {
        icon: <FileCheck className="w-12 h-12 md:w-16 md:h-16" />,
    ...
    "Business Licensing": [
      {
        icon: <ShoppingCart className="w-12 h-12 md:w-16 md:h-16" />,
    ...
    "Intellectual Property": [
      {
        icon: <Tag className="w-12 h-12 md:w-16 md:h-16" />,
      ...
      {
        icon: <Copyright className="w-12 h-12 md:w-16 md:h-16" />,
      ...
      {
        icon: <Gem className="w-12 h-12 md:w-16 md:h-16" />,
      ...
      {
        icon: <Palette className="w-12 h-12 md:w-16 md:h-16" />,
  ...
  const [selectedService, setSelectedService] = useState<ServiceItem | null>(
    contentData[tabs[0]] && contentData[tabs[0]].length > 0 ? contentData[tabs[0]][0] : null
  );
  ...
  return (
    <div ref={sectionRef} className="w-full bg-gradient-to-b from-slate-50 to-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 py-16 md:py-24 md:px-6 lg:px-8">
        {/* Header Section */}
        <div className="text-center mb-2 md:mb-4">
          <div
            className={`inline-flex items-center gap-2 px-5 py-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl mb-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-full'
              }`}
          >
            <div className="flex items-center gap-2">
              <div className="relative">
                <Shield className="w-5 h-5 text-blue-900 animate-pulse" />
          ...
          <div className="overflow-hidden">
            <h1
              className={`font-serif text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mb-6 md:mb-8 leading-tight transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                }`}
            >
              <span className="block">Navigating Legal Excellence</span>
        ...
        <div className="w-full max-w-7xl mx-auto mb-8">
          <div className="flex flex-nowrap gap-4 md:gap-6 border-b border-slate-200">
            {tabs.map((tab, index) => (
              <div
                key={index}
              ...
              >
                <button
                  ...
                  className={`px-1 py-3 md:py-4 font-semibold text-base md:text-lg transition-all duration-300 relative whitespace-nowrap cursor-pointer ${activeTab === index
                    ? "text-blue-900"
                    : "text-slate-700 hover:text-blue-800"
                    }`}
                >
                  {tab}
                  <div className={`absolute bottom-0 left-0 right-0 h-1 transition-all duration-300 ${activeTab === index
        ...
        <div className="relative min-h-[500px]">
          ...
          <div className="absolute -bottom-20 -right-20 w-80 h-80 bg-indigo-100 rounded-full blur-3xl opacity-30"></div>

          <div
            className={`grid grid-cols-1 lg:grid-cols-12 gap-8 h-full transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
              }`}
          >
            {/* Services Sidebar - No Icons */}
            <div className="lg:col-span-4 h-full">
              <div className="relative bg-white rounded-2xl shadow-xl border border-slate-200/80 overflow-hidden backdrop-blur-sm h-full">
                <div className="absolute inset-0 bg-gradient-to-br from-white via-blue-50/30 to-white"></div>
                <div className="relative h-full flex flex-col">
                  <div className="bg-gradient-to-r from-blue-900 via-blue-800 to-indigo-800 px-8 py-6">
                        ...
                        {currentServices.map((service, index) => (
                          ...
                          >
                            <button
                              ...
                              className={`w-full group text-left p-5 rounded-xl transition-all duration-300 flex items-center justify-between backdrop-blur-sm ${selectedService?.title === service.title
                                ? "bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 shadow-md shadow-blue-100/50"
                                : "bg-white/50 hover:bg-blue-50/30 border border-slate-100 hover:border-blue-200"
                                }`}
                            >
                              <span className={`font-semibold text-sm md:text-base leading-snug transition-colors duration-300 ${selectedService?.title === service.title
                                ? "text-blue-900"
                              ...
                              <ChevronRight
                                className={`w-5 h-5 transition-all duration-300 flex-shrink-0 ${selectedService?.title === service.title
                                  ? "text-blue-900 translate-x-2 scale-110"
              ...
              >
                ...
                {selectedService ? (
                  <div className="relative p-8 md:px-12 lg:px-14 h-full overflow-y-auto">
                    {/* Icon with Animation */}
                    <div className="inline-flex items-center justify-center mb-6 animate-icon-bounce">
                      <div className="relative">
                        <div className="absolute inset-0 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-2xl blur-xl opacity-30 animate-pulse"></div>
                        <div className="relative w-16 h-16 md:w-22 md:h-22 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl flex items-center justify-center shadow-lg shadow-blue-200/50">
                    ...
                    <div className="overflow-hidden mb-4">
                      <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-slate-900 leading-tight animate-slide-in-text">
                    ...
                    <div className="overflow-hidden">
                      <p className="text-base md:text-lg text-slate-600 mb-10 leading-relaxed animate-fade-in-delayed">
                    ...
                    {selectedService.href && (
                      <div className="animate-fade-in-delayed-2">
                        <a
                          ...
                          className="group relative inline-flex items-center gap-3 px-10 py-4 bg-gradient-to-r from-blue-900 via-blue-800 to-indigo-800 text-white rounded-2xl font-bold shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 overflow-hidden"
                        >
                          <div className="absolute inset-0 bg-gradient-to-r from-indigo-600 to-blue-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                          <span className="relative z-10 tracking-wide">Explore Detailed Solutions</span>
                  ...
                  <div className="relative p-12 text-center flex flex-col items-center justify-center h-full overflow-y-auto">
                    ...
                    <p className="text-slate-500 max-w-md mx-auto text-lg">
                      Choose from our comprehensive range of legal and compliance services to view detailed information
                    </p>
                  </div>
                )}
              </div>
      ...
      <style jsx>{`
        ...
        .animate-slide-in-text {
          animation: slideInText 0.5s cubic-bezier(0.16, 1, 0.3, 1) 0.1s forwards;
          opacity: 0;
        }
        ...
        .animate-fade-in-delayed-2 {
          animation: fadeInDelayed 0.5s cubic-bezier(0.16, 1, 0.3, 1) 0.3s forwards;
          opacity: 0;
        }
