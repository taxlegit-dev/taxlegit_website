          ...
          <div className="flex flex-col items-center">
            <div className="flex items-center justify-center mb-6 gap-6">
              <div className="relative">
                ...
                <div className="relative p-4 bg-gradient-to-br from-purple-600 to-purple-700 rounded-2xl shadow-xl">
                  {icon}
                </div>
              </div>
                ...
                <>
                  ...
                  >
                    <div className="flex items-center">
                      <span className="w-8 h-8 bg-purple-600 text-white rounded-lg flex items-center justify-center mr-4 font-semibold">
                        {section.id}
                      </span>
              ...
              {contactInfo.note && (
                <div className="mt-8 p-4 bg-purple-50 rounded-lg border border-purple-100">
                  <p className="text-center text-gray-700">
                    <span className="font-semibold text-purple-600">Note:</span>{" "}
                    {contactInfo.note}
                  </p>
                </div>
              )}
